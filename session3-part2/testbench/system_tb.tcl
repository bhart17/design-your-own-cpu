simvision {
    ...
    waveform add -signals system_tb.DUT.core0.PC_fetch
    waveform add -signals system_tb.DUT.core0.instruction
    waveform add -cdivider divider
    waveform add -signals system_tb.DUT.core0.PC_exe
    waveform add -signals system_tb.DUT.core0.instruction_exe
    waveform add -cdivider divider
    ...
    waveform add -cdivider divider
    waveform add -signals system_tb.gpio
